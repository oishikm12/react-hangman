...
import { WrongLetters, Word } from '../index';

function Figure({ data: { selectedWord, correctLetters, wrongLetters } }) {
  const errors = wrongLetters.length;

  return (
    <div className={styles['game-container']}>
      <svg height="250" width="200" className={styles['figure-container']}>
        {/* Rod */}
